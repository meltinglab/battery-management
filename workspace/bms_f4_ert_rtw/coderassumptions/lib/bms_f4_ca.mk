...
## Generated on : Wed Jun 02 11:40:53 2021
...
COMPILER_COMMAND_FILE     = bms_f4_ca_comp.rsp
CMD_FILE                  = bms_f4_ca.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = bms_f4_ca.lib
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DCA_CHECK_FLOATING_POINT_ENABLED=1 -DPROFILING_DEFINE_UINT64_TIMER_TYPE -DCA_CHECK_LONG_LONG_ENABLED=0 -DCA_CHECK_DYNAMIC_MEMORY=0 -DCA_CHECK_DAZ_ENABLED=1
DEFINES_SKIPFORSIL = -DNRT -DUSE_STDPERIPH_DRIVER -DUSE_STM32F4_DISCOVERY -DSTM32F4XX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1U -DHSE_VALUE=8000000 -DNULL=0 -D__START=_start -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/bms_f4_ert_rtw/coderassumptions/bms_f4_ca.c
...
OBJS = coder_assumptions_hwimpl.o coder_assumptions_flt.o bms_f4_ca.o
...
%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/lib/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/lib/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/lib/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
bms_f4_ca.o : $(START_DIR)/bms_f4_ert_rtw/coderassumptions/bms_f4_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
